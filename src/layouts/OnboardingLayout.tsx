...
const testimonials = [
  {
    quote: "I love how conflux has greatly reduced the mental load of hiring staff, now i look foward to interviews because the best candidates are infront of me",
  ...
  return (
    <div className="w-full min-h-screen bg-[#0D2D54] flex gap-[3.19rem] p-[1.5rem] font-sans">
      ...
      <div className="hidden lg:block text-white ml-[2.94rem] w-[40%]">
        <div>
          <img src="/company-logo-white.svg" alt="Conflux" className="w-[6.44rem] h-[1.81rem] mt-[3rem] mb-[5rem]" />
          <h2 className="text-[#00F0FF] text-[0.88rem] font-medium">
            GET STARTED
          </h2>
